...
#### OUTPUTS
- **summary_class_intake_by_entry.csv**, polyphenol class intakes by recall for each participant
...
Available for users who prefer wide format for their analyses (e.g. machine learning).
```{r}
