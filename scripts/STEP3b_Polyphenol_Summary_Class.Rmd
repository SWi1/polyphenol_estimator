...
### OUTPUTS
- **Input_FooDB_polyphenol_content_class_by_recall.csv**, polyphenol class intakes by recall for each participant
- **Input_FooDB_polyphenol_content_class_by_subject.csv**, polyphenol class intakes for each participant, provided in wide format (classes as rows)
- **Input_FooDB_polyphenol_content_class_by_subject_wide.csv**, polyphenol class intakes for each participant, provided in wide format (classes as columns)
