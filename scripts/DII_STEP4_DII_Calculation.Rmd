...
-   **Input_total_nutrients.csv**: Total nutrient intakes for unique participant and recall combination. Generated from step 1 of the polyphenol estimation pipeline.
-   **Input_FooDB_DII_eugenol_by_recall.csv**: Sum eugenol intake for each participant recall
-   **Input_FooDB_DII_subclass_by_recall.csv**: Sum of 6 DII polyphenol subclass intakes for each participant recall
-   **Input_DII_foods_by_recall.csv** - Intake of 7 DII 2014 food categories by participant recall
