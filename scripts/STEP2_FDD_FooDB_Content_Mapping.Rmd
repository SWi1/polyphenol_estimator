...
-   **Diet_Disaggregated.csv.bz2**: Input dietary data that has been disaggregated using FDD.
...
#### OUTPUTS
- **Diet_Disaggregated_mapped.csv.bz2**; Disaggregated dietary data, mapped to FooDB foods
...
Column grouping depends on whether diet output is from a record or recall.
```{r}
