...
-   **Input_Disaggregated.csv.bz2**: Input dietary data that has been disaggregated using FDD.
...
### OUTPUTS
- **Input_Disaggregated_mapped.csv.bz2**; Dissagregated dietary data, mapped to FooDB foods
- **Input_FooDB_polyphenol_content.csv.bz2**: Disaggregated dietary data, mapped to FooDB foods and polyphenol content
