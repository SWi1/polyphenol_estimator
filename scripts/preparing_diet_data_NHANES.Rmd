...
2.  **2021 - 2023 Dietary Interview** - Featuring two separate diet recalls
...
- **NHANES_2021_2023_diet_adults.csv.bz2** - NHANES 2021-2023 ingredient-level diet data, first and second recalls combined, filtered for adults >=20 years old. Each participant has two complete recalls.
...
2.  **Dietary Interview** - "Individual Foods, First Day" and "Individual Foods, Second Day" - Diet data is stored in separate files which we will combine later.
...
**Note**: This is not an exhaustive list of data filtering steps for 24-hour recall data. Users may want to filter for specific populations or perform additional diet cleaning steps (e.g. Calorie or Portion Outliers).
